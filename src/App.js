...
function App() {
  ...
  const getTracks = async ()=>{
    ...
    setIsLoading(true)
    let data =await fetch(`https://v1.nocodeapi.com/aditya11999988/spotify/SoBWqTEAAvpSNOWn/search?q=${keyword ===""?"trending":keyword}&type=track`);
